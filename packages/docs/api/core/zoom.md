...
```ts
function attachZoomBehavior(element: ZoomTargetElement | null | undefined, behavior: ZoomBehavior<SVGSVGElement, unknown>): void;
```
...
```ts
function createZoomBehavior<TElement, TDatum>(context?: MapContext, options?: ZoomBehaviorOptions<TElement, TDatum>): ZoomBehavior<TElement, TDatum>;
```
...
| ------ | ------ |
| `TElement` *extends* `Element` | `SVGSVGElement` |
| `TDatum` | `unknown` |
...
| `options?` | [`ZoomBehaviorOptions`](#zoombehavioroptions)<`TElement`, `TDatum`> |

#### Returns

[`ZoomBehavior`](#zoombehavior)<`TElement`, `TDatum`>
...
| Property | Type |
| ------ | ------ |
| <a id="property-behavior"></a> `behavior` | [`ZoomBehavior`](#zoombehavior)<`SVGSVGElement`, `unknown`> |
...
| ------ | ------ | ------ |
| <a id="property-behavior-1"></a> `behavior` | [`ZoomBehavior`](#zoombehavior)<`SVGSVGElement`, `unknown`> | [`ApplyZoomOptions`](#applyzoomoptions).[`behavior`](#property-behavior) |
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-metadata"></a> `[metadata]` | `public` | `DecoratorMetadataObject` | `null` | - | `Function.[metadata]` |
| <a id="property-arguments"></a> `arguments` | `public` | `any` | - | `Function.arguments` |
| <a id="property-caller"></a> `caller` | `public` | `Function` | - | `Function.caller` |
| <a id="property-length"></a> `length` | `readonly` | `number` | - | `Function.length` |
| <a id="property-name"></a> `name` | `readonly` | `string` | Returns the name of the function. Function names are read-only and can not be changed. | `Function.name` |
| <a id="property-prototype"></a> `prototype` | `public` | `any` | - | `Function.prototype` |
...
* [`ZoomProps`](#zoomprops)<`TElement`, `TDatum`>.[`ZoomEvents`](#zoomevents)
...
| <a id="property-translateextent"></a> `translateExtent?` | [`Extent`](#extent-1) | [`ZoomProps`](#zoomprops).[`translateExtent`](#property-translateextent-3) |
...
| <a id="property-translateextent-1"></a> `translateExtent` | [`Extent`](#extent-1) |
...
| <a id="property-translateextent-2"></a> `translateExtent?` | [`Extent`](#extent-1) |
...
### ZoomBehaviorMethodArgs

```ts
type ZoomBehaviorMethodArgs<TElement, TDatum, TMethod> = ZoomBehavior<TElement, TDatum>[TMethod] extends (...args: infer TArgs) => unknown ? TArgs : never;
```
...
| `TDatum` |
| `TMethod` *extends* [`ZoomBehaviorMethodName`](#zoombehaviormethodname)<`TElement`, `TDatum`> |
...
### ZoomBehaviorSingleArg

```ts
type ZoomBehaviorSingleArg<TElement, TDatum, TMethod> = ZoomBehaviorMethodArgs<TElement, TDatum, TMethod> extends [infer TArg] ? TArg : never;
```
...
```ts
type ZoomModifiers<TElement, TDatum> = Partial<{ [K in ZoomBehaviorMethodName<TElement, TDatum>]: ZoomModifierValue<TElement, TDatum, K> }>;
```
...
```ts
type ZoomModifierValue<TElement, TDatum, TMethod> = 
